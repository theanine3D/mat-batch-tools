...
Addon for [Blender](https://www.blender.org/) (3.4+) that allows batch modifications of many materials and nodes simultaneously, and automates common repetitive tasks on models with many materials. Useful for baking many textures into one - such as with megatextures, texture atlases, etc.
