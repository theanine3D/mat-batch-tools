...
## Features:
- **Node Unify** - Sets a selected node as a template, and then applies its settings to all other nodes of the same type, in all materials, in all selected objects. 
