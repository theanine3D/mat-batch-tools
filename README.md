...
- **Isolate by Material Trait** - Separates faces that have assigned materials with certain traits, in all selected meshes, to a separate object automatically. Currently, two traits are supported - Emissive and Transparent. An optional setting can automatically move geometry to a dedicated collection for easier finding.
